    ...
    ScreencopyView {
        ...
        transform: Rotation {
            ...
            angle: {
                ...
                const monId = Config.options.overview.workspaceToMonitor[wsId]
                const shouldRotate = Config.options.overview.forceRotateMonitors[monId] ?? false
                return shouldRotate ? 180 : 0
            }
        }
