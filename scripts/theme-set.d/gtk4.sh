# GTK4/libadwaita theme generation
# Receives: $base00-$base0F, $THEME_NAME

GTK4_DIR="$HOME/.config/gtk-4.0"

# Skip if GTK4 dir doesn't exist
[[ ! -d "$GTK4_DIR" ]] && mkdir -p "$GTK4_DIR"

# Remove existing theme symlinks 
rm -f "$GTK4_DIR/gtk.css" "$GTK4_DIR/gtk-dark.css" "$GTK4_DIR/assets" 2>/dev/null

# Generate GTK4 CSS with base16 colors
...
EOF
# Note: Don't touch settings.ini - user manages via nwg-look/gsettings
